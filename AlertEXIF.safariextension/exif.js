...
EXIF.EXIFString = function(oFile) {
	...
	exifString += "光圈值:        " + "f / " + exif.FNumber + "\n";
	exifString += "焦距:           " + exif.FocalLength + "\n";
	exifString += "等效焦距:     " + exif.FocalLengthIn35mmFilm + "\n";
	exifString += "ISO值:          " + exif.ISOSpeedRatings + "\n";
	exifString += "曝光补偿:     " + exif.ExposureBias + "\n";
	exifString += "白平衡:        " + exif.WhiteBalance + "\n";
	exifString += "软件:           " + exif.Software + "\n";
	exifString += "拍摄时间:     " + exif.DateTimeOriginal + "\n";
	exifString += "尺寸:           " + exif.PixelXDimension + " x " + exif.PixelYDimension + "\n";
	exifString = exifString.replace(/:.*(undefined)|(NaN).*/g, "");
	return exifString;
};
